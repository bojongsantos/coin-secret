...
export const MESSAGES = {
  ...
  "auth.verifyEmailNotice": {
    id: "Jika alamat ini dapat didaftarkan, kode verifikasi telah dikirim. Periksa kotak masuk dan spam sebelum login.",
    en: "If this address can be registered, a verification code has been sent. Check your inbox and spam before signing in.",
  },
  "auth.verifyTitle": { id: "Verifikasi email", en: "Verify your email" },
  "auth.verifyCodeHelp": {
    id: "Masukkan kode 6 angka dari email. Kode berlaku 5 menit.",
    en: "Enter the 6-digit code from your email. It expires in 5 minutes.",
  },
  "auth.verifyCodePlaceholder": { id: "Kode 6 angka", en: "6-digit code" },
  "auth.resendCode": { id: "Kirim ulang kode", en: "Resend code" },
  "auth.codeSent": { id: "Jika akun tersedia, kode baru telah dikirim. Periksa kotak masuk dan spam.", en: "If the account exists, a new code has been sent. Check your inbox and spam." },
  "auth.verifyCodeError": { id: "Kode verifikasi tidak valid atau kedaluwarsa.", en: "The verification code is invalid or expired." },
  "auth.verifySuccess": { id: "Email berhasil diverifikasi. Silakan login untuk masuk.", en: "Your email has been verified. Sign in to continue." },
  ...
  "auth.confirmPassword": { id: "Ulangi password", en: "Confirm password" },
  "auth.passwordMismatch": { id: "Kedua password tidak sama.", en: "The passwords do not match." },
  "auth.holdToViewPassword": { id: "Tahan untuk melihat password", en: "Hold to view password" },
  ...
  "billing.forgotPasswordHelp": { id: "Lupa password saat ini? Verifikasi melalui email:", en: "Forgot your current password? Verify by email:" },
  ...
  "recovery.forgotBlurb": {
    id: "Kami akan mengirim kode reset ke email terdaftar.",
    en: "We will send a reset code to the registered address.",
  },
  ...
  "recovery.linkSent": {
    id: "Jika akun tersedia, kode reset telah dikirim.",
  ...
  "recovery.sendLink": { id: "Kirim kode reset", en: "Send the reset code" },
