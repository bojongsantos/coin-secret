...
/**
 * Renders the two-panel proof image on demand from the stored snapshot data.
 *
 ...
 * times over. Existing snapshots already carry the candles and timestamps
 * needed for both the entry and result panels.
 */
